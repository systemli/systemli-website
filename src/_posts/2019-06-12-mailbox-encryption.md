...
* You should [generate a recovery token]({% post_url 2019-03-03-password-recovery-en.md %}) in order to activate it
...
Moreover you absolutely should generate a recovery token for your account at [user.systemli.org](https://users.systemli.org/) so that you're able to recover your account in case of password loss. Details about that can be found [in an earlier article]({% post_url 2019-03-03-password-recovery-en.md %}).
