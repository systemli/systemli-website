...
* You should [generate a recovery token](/en/2019/03/03/password-recovery.html) in order to activate it
...
Moreover you absolutely should generate a recovery token for your account at [user.systemli.org](https://users.systemli.org/) so that you're able to recover your account in case of password loss. Details about that can be found [in an earlier article](/en/2019/03/03/password-recovery.html).
